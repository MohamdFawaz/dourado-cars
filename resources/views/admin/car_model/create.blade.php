                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <form class="form form-vertical" method="post" action="{{route('car-model.store')}}"
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="first-name-vertical" class="form-control"
                                                               name="name" placeholder="Car Model Name">
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="mb-3">
...
@section('js')
    ...
    <script>
        const elem = document.querySelector('.choices-select');
    </script>
@endsection
